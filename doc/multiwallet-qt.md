...
In order to support loading of multiple wallets in gdc-qt, a few changes in the UI architecture will be needed.
...
Changes to gdc.cpp
----------------------
gdc.cpp is the entry point into gdc-qt, and as such, will require some minor modifications to provide hooks for

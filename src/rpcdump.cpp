...
Value bip38encrypt(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38encrypt \"gdcaddress\"\n"
            "\nEncrypts a private key corresponding to 'gdcaddress'.\n"
            "\nArguments:\n"
            "1. \"gdcaddress\"   (string, required) The gdc address for the private key (you must hold the key already)\n"

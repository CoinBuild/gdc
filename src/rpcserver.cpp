...
//		{"message", "sendmessage", &sendmessage, false, false, true},
                {"message", "sendmessage", &sendmessage, true, true, false},
//              {"message", "sendmessagefrom", &sendmessagefrom, false, false, true},
		{"message", "sendmessagefrom", &sendmessagefrom, true, true, false},
//              {"message", "listmessages", &listmessages, false, false, true},
		{"message", "listmessages", &listmessages, true, true, false},
//              {"message", "messagesbyheight", &messagesbyheight, false, false, true},
		{"message", "messagesbyheight", &messagesbyheight, true, true, false},
//              {"message", "decodebase64", &decodebase64, false, false, true}
		{"message", "decodebase64", &decodebase64, true, true, false},
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:47200/\n";
}

...
const string strMessageMagic = "GDC Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if(nHeight <= 1 && nHeight > 0) {
        nSubsidy = 105120 * COIN;
	} else if (nHeight > 10 && nHeight <=11) {
		nSubsidy = 31536 * COIN;
	} else if (nHeight > 20 && nHeight <= 21) {
		nSubsidy = 51560 * COIN; 
	} else if (nHeight > 30 && nHeight <= 31) {
		nSubsidy = 21024 * COIN;
	} else if (nHeight > 41 && nHeight <= 2000) {
		nSubsidy = 0.1 * COIN;
	} else if (nHeight > 2000 && nHeight <= 1051200) {
		nSubsidy = 10 * COIN;
	}
    return nSubsidy;
}

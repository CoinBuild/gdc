/* src/config/gdc-config.h.  Generated from gdc-config.h.in by configure.  */
/* src/config/gdc-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "http://bit.gdcs"

/* Define to the full name of this package. */
#define PACKAGE_NAME "GUARDIAN"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "GUARDIAN 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "gdc"

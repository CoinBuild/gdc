                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GDC-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GUARDIAN"), this);
    aboutAction->setStatusTip(tr("Show information about GUARDIAN"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the GUARDIAN help message to get a list with possible GDC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GUARDIAN client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("GUARDIAN"); // default title

...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The GDC address to send the payment to", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the GDC: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the GDC network.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP

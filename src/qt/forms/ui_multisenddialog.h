...
public:
    ...
    void retranslateUi(QDialog *MultiSendDialog)
    {
        ...
        label_2->setText(QApplication::translate("MultiSendDialog", "MultiSend allows you to automatically send up to 100% of your stake or masternode reward to a list of other GDC addresses after it matures.\n"

...
// Copyright (c) 2015-2016 The Gdc developers
...
private:
    ...
    /// Get 10000 GDC input that can be used for the Masternode
...
{
public:
    /// Is the inputs associated with this public key? (and there is 10000 GDC - checking if valid masternode)
